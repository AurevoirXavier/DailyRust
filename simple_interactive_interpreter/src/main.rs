fn main() {
    ...
    assert_eq!(i.input("13 + (y = 3)"), Ok(Some(16.0)));
    assert_eq!(i.input("y"), Ok(Some(3.0)));
    ...
    assert_eq!(i.input("fn one => 1"), Ok(None));
    assert_eq!(i.input("x = 1"), Ok(Some(1.0)));
    assert_eq!(i.input("x = y = 713"), Ok(Some(713.0)));
    assert_eq!(i.input("x"), Ok(Some(713.0)));
    assert_eq!(i.input("y"), Ok(Some(713.0)));
    assert_eq!(i.input("fn echo x => x"), Ok(None));
    assert_eq!(i.input("fn add x y => x + y"), Ok(None));
    assert_eq!(i.input("add echo 4 echo 3"), Ok(Some(7.0)));
    assert_eq!(i.input("x = 0"), Ok(Some(0.0)));
    assert_eq!(i.input("fn f => 1"), Ok(None));
    assert!(i.input("f = 1").is_err());
    assert!(i.input("42 = 3.14").is_err());
    assert_eq!(i.input("(4 + 2) * 3"), Ok(Some(18.0)));
    assert_eq!(i.input("(7 + 3) / (2 * 2 + 1)"), Ok(Some(2.0)));
    assert_eq!(i.input("x = 23"), Ok(Some(23.0)));
    assert_eq!(i.input("x = 25"), Ok(Some(25.0)));
