fn main() {
    //    println!("{}", interpreter("*e*e*e*es*es*ws*ws*w*w*w*n*n*n*ssss*s*s*s*", 5000, 6, 9));
    //    println!("{}", interpreter("*[s[e]*]", 100, 10, 10));
    //    println!("{}", interpreter("*[[n*e*]n[*]*]", 2070, 8, 8));
    //    println!("{}", interpreter("*[s[e]*]", 23, 5, 5));
}
